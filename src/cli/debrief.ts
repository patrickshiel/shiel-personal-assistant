...
export async function runDebrief(options: {
  ...
  const userMessage = `Process this meeting summary and/or transcript. Synthesise into Obsidian notes, add action items to Todoist (mark priority items as high priority), and carve out calendar focus blocks for priority tasks.\n\n## Meeting summary and/or transcript\n\n${combined}`;
